...
def data(scenario, objective1, objective2):
    ...
    eco_baseTEMA = [baseTEMA[h] * baseTEMA[factor] for h in baseTEMA if h == "cost_eco_indicator"]
    ...
    eco_simTEMA = [simTEMA[h] * simTEMA[factor] for h in simTEMA if h == "cost_eco_indicator"]
